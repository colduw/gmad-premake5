...
`premake5 --outdir="bin/" --bootil_lib="c:/bootil/projects/(debug|release)/" --bootil_inc="c:/bootil/include/" vs2010`

Or on linux

`premake5 --outdir="bin/" --bootil_lib="/whatevs/bootil/projects/(debug|release)/" --bootil_inc="/whatevs/bootil/include/" gmake`
